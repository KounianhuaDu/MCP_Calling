#!/bin/bash
SOURCE_DIR="/inspire/hdd/project/multi-agent/zhangweinan-24046/dk/LiveMCP/annotated_data"
DEST_DIR="/inspire/hdd/project/multi-agent/zhangweinan-24046/dk/virtual_root"
