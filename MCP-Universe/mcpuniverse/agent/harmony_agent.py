...
""".strip()'''
        output_format_prompt = """You MUST respond in the following **exact format** with two clearly separated channels:
...
- The two channels must appear in this order and exactly once each.""".strip()
